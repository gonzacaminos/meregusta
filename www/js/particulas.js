...
function Particle(context) {
    ...
    if(open) {  // Si el micrófono esta abierto
        ...
        if (this.vive) { 
               ...
               if (this.y <= 0 ) {  // Si la particula vive y pasa el borde superior
...
function init() {
    ...
    if (canvas.getContext) {
        ...
        for(var i=0; i < particleCount; ++i){
            ...
            particle.setPosition(generateRandom(0, canvasWidth),  generateRandom(0, 500));
...
particles.forEach(function(particle) {
        ...
        particle.vive=true;
        particle.setPosition(generateRandom(0, canvasWidth),  generateRandom(0, 600));
